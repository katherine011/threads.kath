      ...
      <div className="flex flex-col justify-between items-center h-[270px] mt-14">
        <Link href={"/home"}>
          <svg
            ...
            viewBox="0 0 576 512"
            className={`w-6 h-6 fill-current  cursor-pointer hover:text-black transition-colors duration-200 
              ${pathname === "/home" ? "text-black" : "text-gray-400"}`}
          >
        ...
        <Link href={"/search"}>
          <svg
            ...
            viewBox="0 0 512 512"
            className={`w-6 h-6 fill-current  cursor-pointer hover:text-black transition-colors duration-200 
              ${pathname === "/search" ? "text-black" : "text-gray-400"}`}
          >
            <path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" />
          </svg>
        </Link>
        <div className="w-[60px] h-[50px] flex items-center justify-center bg-gray-200 rounded-[11px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
        ...
        <Link href={"/notification"}>
          <svg
            ...
            viewBox="0 0 512 512"
            className={`w-6 h-6 fill-current  cursor-pointer hover:text-black transition-colors duration-200 
              ${pathname === "/notification" ? "text-black" : "text-gray-400"}`}
          >
